...
void display(void)
{
	...
	gluSphere(quadric, 1.0f, 50, 50); // ha sphere draw karnare , glu mdhla ahe he , 2:radius of sphere , 3,4 : sphere la subdivision kr, MOre the subdivision smoother the surface

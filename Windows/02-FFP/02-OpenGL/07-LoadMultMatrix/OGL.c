// Output : https://www.youtube.com/watch?v=z1tkpaNxJNQ&pp=ygUcb2VwbmdsIGN1YmUgZml4ZWQgZnVuY3Rpb25hbA%3D%3D
...
int initialize(void)
{
	...
	translationMatrix[12] = 0.0f; // gltranslate mdhla x 0 ahe mhnun
	translationMatrix[13] = 0.0f; // gltranslatef mdhla y 0 ahe mhnun
	translationMatrix[14] = -6.0f; // gltranslatef mdhla z
	...
	scaleMatrix[3] = 0.0f;
	scaleMatrix[4] = 0.0f;
	scaleMatrix[5] = 0.75f; // glscalef mdhla y
	scaleMatrix[6] = 0.0f;
	scaleMatrix[7] = 0.0f;
	scaleMatrix[8] = 0.0f;
	scaleMatrix[9] = 0.0f;
	scaleMatrix[10] = 0.75f; // glscale mdhla z
	scaleMatrix[11] = 0.0f;
	scaleMatrix[12] = 0.0f;
	scaleMatrix[13] = 0.0f;
	scaleMatrix[14] = 0.0f;

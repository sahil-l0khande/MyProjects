// OUTPUT : https://www.youtube.com/watch?v=cHdTcWoZyRE
...
GLuint texture_stone;	// Pyramid
GLuint texture_kundali; // Cube
...
int initialize(void)
{
	...
	if (loadGLTexture(&texture_stone, MAKEINTRESOURCE(IDBITMAP_STONE)) == FALSE ) {
		fprintf(gpFile, "loadGLTexture failed for stone\n");
		return -6;
	}

	if (loadGLTexture(&texture_kundali, MAKEINTRESOURCE(IDBITMAP_KUNDALI)) == FALSE) {
		fprintf(gpFile, "loadGLTexture failed for kundali\n");
		return -7;
	}
...
void display(void)
{
	...
	glTexCoord2f(1.0f, 1.0f); // top-right of front
	glVertex3f(1.0f, 1.0f, 1.0f);

	glTexCoord2f(0.0f, 1.0f); // top-left of front
	glVertex3f(-1.0f, 1.0f, 1.0f);

	glTexCoord2f(0.0f, 0.0f); // bottom-left of front
	glVertex3f(-1.0f, -1.0f, 1.0f);

	glTexCoord2f(1.0f, 0.0f); // bottom-right of front
	glVertex3f(1.0f, -1.0f, 1.0f);


	// Right face

	glTexCoord2f(1.0f, 1.0f); // top-right of right
	glVertex3f(1.0f, 1.0f, -1.0f);

	glTexCoord2f(0.0f, 1.0f); // top-left of right
	glVertex3f(1.0f, 1.0f, 1.0f);

	glTexCoord2f(0.0f, 0.0f); // bottom-left of right
	glVertex3f(1.0f, -1.0f, 1.0f);

	glTexCoord2f(1.0f, 0.0f); // bottom-right of right
	glVertex3f(1.0f, -1.0f, -1.0f);

	// Back face
	
	glTexCoord2f(1.0f, 1.0f); // top-right of back
	glVertex3f(-1.0f, 1.0f, -1.0f);
	
	glTexCoord2f(0.0f, 1.0f); // top-left of back
	glVertex3f(1.0f, 1.0f, -1.0f);

	glTexCoord2f(0.0f, 0.0f); // bottom-left of back
	glVertex3f(1.0f, -1.0f, -1.0f);

	glTexCoord2f(1.0f, 0.0f); // bottom-right of back
	glVertex3f(-1.0f, -1.0f, -1.0f);

	// Left face
	
	glTexCoord2f(1.0f, 1.0f); // top-right of left
	glVertex3f(-1.0f, 1.0f, 1.0f);

	glTexCoord2f(0.0f, 1.0f); // top-left of left
	glVertex3f(-1.0f, 1.0f, -1.0f);

	glTexCoord2f(0.0f, 0.0f); // bottom-left of left
	glVertex3f(-1.0f, -1.0f, -1.0f);

	glTexCoord2f(1.0f, 0.0f); // bottom-right of left
	glVertex3f(-1.0f, -1.0f, 1.0f);

	// Top face
	
	glTexCoord2f(1.0f, 1.0f); // top-right of top
	glVertex3f(1.0f, 1.0f, -1.0f);

	glTexCoord2f(0.0f, 1.0f); // top-left of top
	glVertex3f(-1.0f, 1.0f, -1.0f);

	glTexCoord2f(0.0f, 0.0f); // bottom-left of top
	glVertex3f(-1.0f, 1.0f, 1.0f);

	glTexCoord2f(1.0f, 0.0f); // bottom-right of top
	glVertex3f(1.0f, 1.0f, 1.0f);

	// Bottom face
	
	glTexCoord2f(1.0f, 1.0f); // top-right of bottom
	glVertex3f(-1.0f, -1.0f, -1.0f);

	glTexCoord2f(0.0f, 1.0f); // top-left of bottom
	glVertex3f(1.0f, -1.0f, -1.0f);

	glTexCoord2f(0.0f, 0.0f); // bottom-left of bottom
	glVertex3f(1.0f, -1.0f, 1.0f);

	glTexCoord2f(1.0f, 0.0f); // bottom-right of bottom
	glVertex3f(-1.0f, -1.0f, 1.0f);
